...
obscene_words_cen = [[1089, 1091, 1082], [1087, 1080, 1079, 1076], [1076, 1072, 1091, 1085],
                     [1093, 1091, 1081], [1077, 1073], [1085, 1072, 1093], [1087, 1086, 1093, 1091],
                     [1087, 1086, 1088, 1085], [1084, 1080, 1085, 1077, 1090], [1093, 1091, 1077, 1089, 1086],
                     [1093, 1091, 1080, 1083], [1076, 1086, 1083, 1073, 1072], [1077, 1073, 1083, 1103]]
...
def check(message: str) -> bool:
    ...
    if message in recensore(obscene_words_cen):
        return True
...
if __name__ == '__main__':
    print(recensore(obscene_words_cen))
